...
const ratings = (props) => {
    ...
    const ratings = {
        exceptional: props.ratings.length > 0 ? props.ratings[0]:0,
        recommended: props.ratings.length > 0 ? props.ratings[1]:0,
        meh: props.ratings.length > 0 ? props.ratings[2]:0,
        skip: props.ratings.length > 0 ? props.ratings[3]:0,
    }
